...
import { SEARCH_ENGINES, splitUrlForDisplay } from '@shared/url';
import type { Suggestion, TabId, TabState } from '@shared/types';
import { Favicon } from '@/components/ui/media/Favicon';
import { ask, send } from '@/lib/bridge';
import { cn } from '@/lib/utils';
import { useBrowserStore } from '@/store/useBrowserStore';
import { ConnectionBadge } from '@/components/chrome/ConnectionBadge/ConnectionBadge';
