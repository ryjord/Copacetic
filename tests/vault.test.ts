...
const { EMPTY_VAULT_FILE, Vault, reviveVaultFile } = await import('../electron/main/vault');
type VaultFile = import('../electron/main/vault').VaultFile;
type SecretStore = import('../electron/main/vault').SecretStore;
