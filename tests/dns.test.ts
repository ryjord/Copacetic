...
import { DEFAULT_RESOLVER_ID, DNS_RESOLVERS, describeDns, dnsSwitchesFor, resolverFor } from '../electron/shared/dns';
import { applyDnsSwitches, readDnsPreference } from '../electron/main/command-line';
