...
const { asSettingsPatch, SETTINGS_NOT_PATCHABLE } = await import('../electron/main/ipc');
const { DEFAULT_SETTINGS } = await import('../electron/main/store');
